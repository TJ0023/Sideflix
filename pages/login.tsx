        ...
        <form onSubmit={handleSubmit(onSubmit)} className="relative mt-24 space-y-8 rounded bg-black/75 py-10 px-6 md:mt-0 md:max-w-md md:px-14">
            ...
            <div className="space-y-4">
                <label className="inline-block w-full">
                    <input type="email" placeholder="Enter Email" className="input" {...register('email', {required: true})}/>
            ...
            <button onClick={() => setLogin(true)} type="submit" className="w-full rounded bg-[#f4a51e] py-3 font-semibold">Sign In</button>
