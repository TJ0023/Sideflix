...
function Membership() {
  ...
  return (
    ...
    <div className="space-y-2 py-4">
            <h4 className="text-lg text-[#b5b5b5]">Membership & Billing</h4>
            <button
        ...
        <div className="flex flex-col justify-between border-b border-white/10 py-4 md:flex-row">
          <div>
            ...
            <p className="text-[gray] text-lg">Password: ********</p>
          </div>
          <div className="md:text-right text-setBillingLoading">
            <p className="membershipLink">Change email</p>
            <p className="membershipLink">Change password</p>
          </div>
        </div>

        <div className="flex flex-col justify-between pt-4 pb-4 md:flex-row md:pb-0 text-lg">
          <div>
            <p>
